...
public class Monstre {
    ...
    // Dans Monstre.java (ajouter ces méthodes)
    ...
    public boolean attaquer(Donjon donjon, String caseCible) {
        ...
        int totalAttaque = jetAttaque + m_strength; // Les monstres utilisent toujours la force

        if (totalAttaque > persoCible.getArmor().getCA()) {
    ...
    public void prendreDegats(int degats) {
        ...
        System.out.println(m_specie + " a maintenant " + m_hp + "/" + m_max_hp + " PV");
    }
